...
schwert02.addEvent('left', function(){
    /*
    * We overwrite all the current text and destroy the sword:
    * */
    sceneTwo.overrideText('Was Du mit dem Schwert machen kannst findest Du im zweiten Tutorial (tutorialTwo.js).');
    schwert02.destroy();
    sceneTwo.updateText();
}, 'Das Schwert nehmen.');
